...
public class GestionException {
    ...
    private void methode4() throws Exception4 {
        if (valeur == 4) throw new Exception4();
    ...
    private void methode5() throws Exception1 {
        ...
        public void faire () {
            ...
            try {
                ...
                System.out.println("récupération de Exception1 " + e);
            } catch (Exception2 e) {
                System.out.println("récupération de Exception2 " + e);
            } catch (Exception3 e) {
                System.out.println("récupération de Exception3 ou 4 " + e);
            } catch (Exception e) {
